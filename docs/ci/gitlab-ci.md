...
Use this template when Breach Gate is published as a container image. Replace `ghcr.io/epten08/breach-gate:2.0.0` with the image location used by this project.
...
security_bot:
  stage: security
  image: ghcr.io/epten08/breach-gate:2.0.0
  variables:
